...
const TOPIK_II=[
  ...
  item(2,'grammar','-더라도','가정해도 결과가 달라지지 않음','～しても','even if','即使……','비가 오더라도 약속은 지킬게요.'),
  item(2,'grammar','-(으)ㄹ 뿐만 아니라','앞 내용에 뒤 내용을 더함','～だけでなく','not only ... but also','不仅……而且……','맛있을 뿐만 아니라 가격도 싸요.'),
  item(2,'grammar','-(으)ㄴ/는 척하다','사실과 다르게 행동함','～ふりをする','pretend to','假装……','알면서도 모르는 척했어요.'),
  item(2,'grammar','-기 마련이다','일반적으로 당연한 경향','当然～するものだ','be bound to','总会……','처음에는 누구나 실수하기 마련이에요.'),
