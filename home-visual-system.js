...
body.tq-home-active .tqStreak{min-height:var(--ui-touch);border:1px solid var(--home-border);background:var(--home-surface);color:var(--home-streak);padding:8px 11px;box-shadow:0 5px 14px var(--home-shadow)}
