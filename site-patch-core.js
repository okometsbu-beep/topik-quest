...
(function(){
  ...
  home=function(sc){
    ...
    sc.innerHTML=`
      <section class="tqHero">
        <img src="${hero}" alt="HARUMAL Korean learning">
        <div class="tqHeroBrand"><b>하루말 · HARUMAL</b><small>TOPIK I·II PREP · UNOFFICIAL</small></div>
  ...
  morePage=function(sc){
    navActive('more');
    sc.innerHTML=`
      <div class="sectionTitle"><h2>${tr('more')}</h2><span>하루말 · HARUMAL</span></div>
      <div class="modeGrid">
