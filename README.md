...
- A last-known-good browser recovery snapshot plus non-destructive backup import for vocabulary, game, review, beginner, travel, and settings records
...
- More Seoul routes using the reusable `travel-mode.js` engine after the first route proves
