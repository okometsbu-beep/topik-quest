...
style.textContent=`
body.tq-review-active{--review-canvas:var(--ui-canvas);--review-surface:var(--ui-surface);--review-surface-raised:var(--ui-surface-raised);--review-surface-soft:var(--ui-surface-soft);--review-border:var(--ui-border);--review-ink:var(--ui-ink);--review-muted:var(--ui-muted);--review-accent:var(--ui-accent);--review-accent-soft:var(--ui-accent-soft);--review-success:var(--ui-success);--review-success-soft:var(--ui-success-soft);--review-error:var(--ui-error);--review-error-soft:var(--ui-error-soft);--review-accent-ink:var(--ui-accent);--review-error-muted:#ffb5c2;--review-shadow:var(--ui-shadow);--review-shadow-strong:var(--ui-shadow-strong);background:var(--review-canvas);color:var(--review-ink)}
html[data-theme="light"] body.tq-review-active{--review-accent-ink:var(--ui-accent);--review-error-muted:#8b5566}
...
body.tq-review-active .tqReviewHero{grid-template-columns:minmax(0,1fr) 74px;gap:var(--ui-space-3);border:1px solid var(--review-border);border-radius:var(--ui-radius-card);padding:var(--ui-space-4);background:var(--review-accent-soft);box-shadow:none}
body.tq-review-active .tqReviewHero small{color:var(--review-muted);font-size:12px;line-height:1.35}
body.tq-review-active .tqReviewHero h1{margin:6px 0;color:var(--review-ink);font-size:20px;line-height:1.25}
body.tq-review-active .tqReviewHero p{margin:0;color:var(--review-muted);font-size:12px;line-height:1.5}
body.tq-review-active .tqReviewHero>strong{width:72px;height:72px;border-radius:var(--ui-radius-control);background:var(--review-surface);color:var(--review-ink);font-size:27px}
body.tq-review-active .tqReviewHero>strong small{font-size:12px}
...
body.tq-review-active .tqReviewFilters button b{display:grid;place-items:center;min-width:23px;height:23px;border-radius:8px;background:var(--review-surface-soft);color:var(--review-muted);font-size:12px}
body.tq-review-active .tqReviewFilters button.on{border-color:var(--review-accent);background:var(--review-accent-soft);color:var(--review-accent-ink);box-shadow:0 0 0 2px rgba(82,104,232,.16)}
body.tq-review-active .tqReviewFilters button.on b{background:var(--ui-accent);color:var(--harumal-on-accent,#fff)}
...
body.tq-review-active .sectionTitle span{color:var(--review-muted);font-size:12px}
...
body.tq-review-active .tqReviewBadge small{color:var(--review-accent-ink);font-size:12px;line-height:1.2}
body.tq-review-active .tqReviewItem>div:nth-child(2){align-self:center;overflow-wrap:anywhere}
body.tq-review-active .tqReviewItem b{color:var(--review-ink);font-size:14px}
body.tq-review-active .tqReviewItem p{max-width:none;margin:4px 0;color:var(--review-muted);font-size:12px;line-height:1.45}
body.tq-review-active .tqReviewItem>div>small{color:var(--review-error-muted);font-size:12px;line-height:1.35}
body.tq-review-active .tqReviewItem>button{grid-column:1/-1;width:100%;border:0;border-radius:var(--ui-radius-control);background:var(--ui-accent);color:var(--harumal-on-accent,#fff);padding:10px 12px;font-size:13px;font-weight:900}
...
body.tq-review-active .tqReviewEmpty p{color:var(--review-muted);font-size:12px;line-height:1.5}
body.tq-review-active .tqClearMastered{min-height:var(--ui-touch);color:var(--review-muted);font-size:12px}
...
body.tq-review-active .tqReviewRetrySheet .reward{border:1px solid #8298ed;border-radius:var(--ui-radius-card);background:var(--review-accent-soft);padding:var(--ui-space-4)}
body.tq-review-active .tqReviewRetrySheet .reward b{font-size:16px;line-height:1.35}
body.tq-review-active .tqReviewRetrySheet .reward small{font-size:12px;line-height:1.4}
...
body.tq-review-active .tqReviewQuestion>small{color:var(--review-muted);font-size:12px;line-height:1.5}
body.tq-review-active .tqReviewQuestion>p{color:var(--review-ink);font-size:14px;line-height:1.65;overflow-wrap:anywhere}
body.tq-review-active .tqReviewScript{border-left-color:#7187df;border-radius:0 10px 10px 0;background:var(--review-surface-soft);color:var(--review-ink);padding:9px 10px;font-size:13px;line-height:1.6;overflow-wrap:anywhere}
body.tq-review-active .tqReviewQuestion ol{padding-left:22px}
body.tq-review-active .tqReviewQuestion li{color:var(--review-muted);font-size:13px;line-height:1.5;overflow-wrap:anywhere}
body.tq-review-active .tqTranslationToggle{width:100%;min-height:48px;border:1px solid var(--review-border);border-radius:var(--ui-radius-control);background:var(--review-surface-soft);color:var(--review-ink);padding:10px 12px;font-size:13px;font-weight:900}
...
body.tq-review-active .tqReviewChoices .choice .n{width:32px;height:32px;border-radius:10px;background:var(--review-surface-soft);color:var(--review-muted);font-size:12px}
body.tq-review-active .tqReviewChoices .choice.selected{border-color:var(--ui-accent);background:var(--review-accent-soft);color:var(--review-accent-ink)}
...
body.tq-review-active .tqReviewRetrySheet .doubleTapHint{border-color:#b9c9dc;background:var(--review-surface-soft);color:var(--review-muted);font-size:12px;line-height:1.5}
body.tq-review-active .tqReviewRetrySheet .resultStrip{border:1px solid color-mix(in srgb,var(--review-success) 58%,var(--review-border));border-radius:var(--ui-radius-control);background:var(--review-success-soft);color:var(--review-success);font-size:13px;line-height:1.5}
...
body.tq-review-active .tqReviewDeep .tqInlineAnswer small,body.tq-review-active .tqReviewDeep h4{color:var(--review-muted);font-size:12px}
body.tq-review-active .tqReviewDeep p{color:var(--review-ink);font-size:14px;line-height:1.7;white-space:pre-line;overflow-wrap:anywhere}
body.tq-review-active .tqReviewDeep blockquote{border-left-color:#7890df;background:var(--review-surface-soft);color:var(--review-muted);font-size:12px;line-height:1.6;overflow-wrap:anywhere}
...
body.tq-review-active .tqReviewChoiceAnalysis b{font-size:13px}
body.tq-review-active .tqReviewChoiceAnalysis span{color:var(--review-muted);font-size:12px;line-height:1.55}
body.tq-review-active .tqReviewRetrySheet>.closeBtn{min-height:48px;border:1px solid var(--review-border);border-radius:var(--ui-radius-control);background:var(--review-surface-soft);color:var(--review-ink);font-size:13px}
