...
try{
  ...
  await evaluate(`malbitTravelSelect(0);malbitTravelSubmit()`);await sleep(220);await shot('03-dialogue-world-reaction.png');
  ...
  await evaluate(`malbitTravelNext()`);await sleep(180);await shot('04-sign-hotspot.png');
  ...
  await evaluate(`malbitTravelSelect(0);malbitTravelSubmit();malbitTravelNext()`);
