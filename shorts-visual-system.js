...
body.tq-shorts-active .shortsExplanation summary{display:flex;align-items:center;min-height:var(--ui-touch);padding:10px 12px;color:var(--shorts-ink);font-size:11px;font-weight:900;cursor:pointer}
body.tq-shorts-active .shortsExplanation small{display:block;border-top:1px solid var(--shorts-border);padding:12px;color:var(--shorts-ink);font-size:11px;line-height:1.72;white-space:pre-line;overflow-wrap:anywhere}
