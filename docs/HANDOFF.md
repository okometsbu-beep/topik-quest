...
- 빈 복습 이력의 해결률 100% 오표시를 ko/ja/en/zh `기록 없음` 상태로 수정하고 실제 기록의 백분율은 보존했다.
- PR #188 squash `3b9626a0fe9b48579df8cfbb96a155ab802054e1`; 전체 145/145, v139 런타임 46개·은행 해시 통과.
- 최종 PR CI `36232225370`; branch CI `36231939294` artifact `10902672716` 247장 중
  빈 복습 320/375/390/430px×라이트/다크 8장을 직접 확인했다. 320px 줄바꿈도 최종 후보에서 제거했다.
- Pages `36232494268` 성공. 라이브 v139와 핵심 3자산 해시 일치, 빈 큐·`기록 없음`·한 줄 표시를 공개 Chrome에서 확인했다.
- main CI `36232494732`와 Pages `36232494268` 성공.
- 데이터·문항·모드 불변. 복귀 기준은 v138 제품 `f6259634e798e4164fe4e547c901ff68832c23ad`.
- 실제 iPhone/Android·일본어 모어 화자·실학습자 회상은 미검증이다. 다음은 clean ja-JP 입문 문법 초안 재진입 검증이다.
