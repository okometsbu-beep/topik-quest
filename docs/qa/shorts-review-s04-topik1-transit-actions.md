...
Production: v129 `8a33bd6025243187d3f569e3ddd85f432ed4cc94` (PR #168).
...
| Deployment | pass | PR #168 final CI `35618582704`, main CI `35619144734`, and Pages `35619143631` passed. Live HTTP reports v129; four core assets match main by SHA-256, all four IDs are present, and public Chrome verified Japanese wrong-answer feedback, expanded coaching, and reload restoration. |

Production inventory is 396 rows / 270 exact question-choice families (TOPIK I 136, TOPIK II 134).
