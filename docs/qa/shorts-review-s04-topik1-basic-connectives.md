...
Candidate: v125. Production remains v124 `10bb264f48b75754c10456f33236d3352f6ba5a0`
until the release gates pass. Product rollback is v124.
...
| Emulated mobile | pending | PR CI must cover 320/375/390/430px light/dark, wrong feedback, expanded coaching, next-first flow, and reload restoration. |
| Human/learner/device | unverified | No native reviewer, consenting learner timing, delayed recall, or physical iPhone/Android evidence. |
| Deployment | pending | No PR, merge, Pages release, or public-browser claim is made yet. |

Candidate inventory is 380 rows / 254 exact question-choice families (TOPIK I 128, TOPIK II 126).
