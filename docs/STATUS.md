...
- Production v118 has 200 TOPIK I / 152 TOPIK II rows and only 112 / 114 distinct
...
- Node 24 집중 vocabulary+inventory 22/22, 콘텐츠 25/25, 전체 release check 119/119과 v119
  ...
  `10489585088`의 `00co`/`00cp`를 직접 확인했다. 최종 증거 커밋 CI·병합·라이브 검증 전에는
  production v118을 유지한다.
