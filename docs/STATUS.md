...
- 집중 데이터·재고 검사는 로컬 Node 22에서 12/12 통과했다. 전체 release check와 PR CI의 Linux
  Chrome 에뮬레이션 320·375·390·430px 라이트/다크, 선택 오답→짧은 복구→다음 문제 우선→상세
  해설과 새로고침 상태 복원은 병합 전 확인한다.
