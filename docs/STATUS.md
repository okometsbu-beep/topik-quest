...
- 집중 데이터·재고 검사 9/9, 로컬 Node 22 전체 검사 100/100과 PR #124 CI `34586448188`의
  전체 검사를 통과했다. 같은 CI의 Linux Chrome 에뮬레이션에서 320·375·390·430px 라이트/다크,
  선택 오답→짧은 복구→다음 문제 우선→접힌 상세 해설과 새로고침 상태 복원을 확인했다.
