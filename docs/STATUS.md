...
- 집중 데이터·재고 검사 11/11, 콘텐츠 검사 14/14, 로컬 Node 22 전체 검사 102/102를 통과했다.
  Linux Chrome 320·375·390·430px 라이트/다크, 선택 오답→짧은 복구→다음 문제 우선→상세 해설과
  새로고침 상태 복원은 체크포인트 뒤 실행하며 아직 통과로 표시하지 않는다.
